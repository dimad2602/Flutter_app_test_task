...
/// @nodoc
@JsonSerializable()
class _$NewsResponseImpl extends _NewsResponse {
  const _$NewsResponseImpl({required final List<NewsDto> news})
      : _news = news,
        super._();
...
abstract class _NewsResponse extends NewsResponse {
  const factory _NewsResponse({required final List<NewsDto> news}) =
      _$NewsResponseImpl;
